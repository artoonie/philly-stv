...
export const SYSTEMS = [
  {
    ...
    short: 'Today',
    name: 'Today’s system',
    detail: '10 single-member districts + 7 at-large seats by limited voting (vote for 5, top 7 win)',
    stv: false,
    build: () => [
  ...
  },
  {
    ...
    detail: 'Keep the 10 single-member districts; elect the 7 at-large seats with STV (one city-wide 7-winner contest)',
    stv: true,
    build: () => [
      ...DISTRICT_IDS.map(d => ({ id: `d${d}`, name: `District ${d}`, districts: [d], seats: 1, method: 'plurality' })),
  ...
  },
  {
    ...
    detail: 'No at-large seats; neighbouring districts paired into 5, each electing 3 members by STV (15 total)',
    stv: true,
  ...
  },
  {
    ...
    detail: 'Today’s 10 districts, each electing 3 members by STV (30 total)',
    stv: true,
